...
export class CustomModal extends Component {
    ...
    renderModIcon= (item) => {
        if (this.props.session === item) {
            return <Image style={{width: 20, height: 20}} source={{uri: "http://dd.prod.assets.s3.amazonaws.com/extensions/question-and-answer/radio_active.png"}}/>
        }
        else {
            return <Image style={{width: 20, height: 20}} source={{uri: "http://dd.prod.assets.s3.amazonaws.com/extensions/question-and-answer/radio_inactive.png"}}/>
        }
   }
